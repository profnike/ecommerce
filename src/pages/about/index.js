...
<div className="">
      <div className="flex flex-col items-start md:flex-row   md:items-center justify-between gap-3 px-4 md:px-10 py-10  bg-primary bg-opacity-10 rounded-b-[10%]   md:rounded-b-[30%] ">
      ...
      <div className="flex flex-col-reverse lg:flex-row  md:justify-between my-10 md:my-16  lg:space-x-5 lg:items-start">

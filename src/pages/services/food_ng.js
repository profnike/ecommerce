...
export default function Plated() {
  return (
    <div>
        <Servicesheader bgImage="/images/Delish-dish.jpg" upperText="Food" lowerText="Ng" />
       <div>
       
      <p className="text-[15px] md:text-base text-center w-[85%] md:w-[75%] lg:w-[65%] mx-auto mb-10 md:mb-14 ">
      At Food_ng, in collaboration with Perrez, we believe great food brings people together, whether you&apos;re hosting an event, grabbing a quick lunch, planning a surprise package for a loved one or you just want to enjoy good food. Our passion is delivering delicious, freshly prepared meals straight to your doorstep.
